...
const terjemahan = {
    en: {
        ...
        project2_title: "ALSHEICO",
        project2_desc: "A machine learning web application, for predict stunting and obesitas with the anime theme Jujutsu Kaisen.",
        ...
        // Certificates
        certificates1_desc: "Completed a fundamental artificial intelligence course organized by Microsoft to understand basic AI concepts.",
    certificates2_desc: "Successfully completed a technical training program focused on Git version control systems and workflow.",
    ...
    certificates5_desc: "Participated in a Laravel framework development training program organized by Telkom Indonesia.",
    certificates6_desc: "Participated as a contestant in the UI/UX Design competition held by Semarang State Polytechnic.",
    certificates7_desc: "Participated in a Web Development competition organized by Soegijapranata Catholic University.",
    ...
    id: {
        ...
        project2_title: "ALSHEICO",
        project2_desc: "Website machine learning yang digunakan untuk memprediksi stunting dan obesitas, menggunakan tema anime jujutsu kaisen",
        project3_title: "Eatscape",
       ...
       certificates1_desc: "Menyelesaikan kursus dasar kecerdasan buatan yang diselenggarakan oleh Microsoft untuk memahami konsep dasar AI.",
        ...
        certificates5_desc: "Mengikuti program pelatihan pengembangan framework Laravel yang diselenggarakan oleh Telkom Indonesia.",
        certificates6_desc: "Berpartisipasi sebagai peserta dalam lomba desain UI/UX yang diselenggarakan oleh Politeknik Negeri Semarang.",
        certificates7_desc: "Berpartisipasi dalam kompetisi Web Development yang diselenggarakan oleh Universitas Katolik Soegijapranata.",
